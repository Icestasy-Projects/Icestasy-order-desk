...
_PLACE_TO_CITY = {
    ...
    **{p: "Pune" for p in [
        ...
        "bavdhan", "bhosari", "bhugaon", "bibwewadi", "chikhali", "dange chowk",
        "dehu road", "erandwane", "expressway", "fc road", "jm road", "karve nagar",
        "katraj", "khandve nagar", "kondhwa", "kopa mall", "law college road",
        "lonavala", "model colony", "moshi", "mulshi", "mundhwa", "nakhra (aundh)",
        "nanded", "navipeth", "nibm road", "nigdi", "pashan", "pimple nilakh",
        "pimple saudagar", "punawale", "ravet", "sadashiv peth", "sangamwadi",
        "sarasbaug", "senapati bapat road", "sinhagad road", "sinhgad road",
        "talegaon", "undri", "wadgaon", "wanwadi", "warje",
    ]},
