...
_PLACE_TO_CITY = {
    ...
    **{p: "Pune" for p in [
        "pune", "koregaon park", "kothrud", "baner", "hinjewadi", "hinjawadi", "viman nagar",
        "aundh", "camp", "camp area", "kharadi", "wakad", "pimpri", "chinchwad",
        "pimpri chinchwad", "hadapsar", "magarpatta", "shivaji nagar", "deccan",
        "deccan gymkhana", "swargate", "kalyani nagar", "wagholi", "akurdi", "balewadi",
        "bavdhan", "bhosari", "bhugaon", "bibvewadi", "bibwewadi", "chikhali",
        "dange chowk", "dehu road", "east street", "erandwane", "expressway",
        "fatima nagar", "fc road", "jm road", "karve nagar", "katraj",
        "khandve nagar", "kondhapuri", "kondhwa", "kopa mall", "law college road",
        "lonavala", "maharshi nagar", "model colony", "moshi", "mulshi", "mundhwa",
        "nakhra (aundh)", "nanded", "navipeth", "nibm road", "nigdi", "pashan",
        "pimple nilakh", "pimple saudagar", "punawale", "ravet", "sadashiv peth",
        "sangamwadi", "sarasbaug", "senapati bapat road", "shikrapur", "shirur",
        "sinhagad road", "sinhgad road", "sus", "talegaon", "tilak road",
        "undri", "wadgaon", "wanwadi", "warje",
    ]},
